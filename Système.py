...
class système():
    ...
    def jouer(self):
        pygame.init()
        self.display = pygame.display.set_mode(self.écranT)
    ...
    def loadImages(self):
        self.images = {}
        for fichier in os.listdir("C:/Users/sasha/PythonImages"):
            if (not fichier.endswith(".png")):
                continue
            image = pygame.image.load(r"C:/Users/sasha/PythonImages/" + fichier)
